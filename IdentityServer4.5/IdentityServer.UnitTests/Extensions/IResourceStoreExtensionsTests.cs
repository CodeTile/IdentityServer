...
namespace IdentityServer.UnitTests.Extensions
{
    public class IResourceStoreExtensionsTests
    {
        ...
        public void FindResourcesByScopeAsync_on_duplicate_identity_scopes_should_fail()
        {
            ...
            Func<Task> act = async () => await store.FindResourcesByScopeAsync(new string[] { "A" });
            act.Should().ThrowAsync<Exception>();//TODO:.And.Message.ToLowerInvariant().Should().Contain("duplicate").And.Contain("identity scopes");
        }
        ...
        public void GetAllEnabledResourcesAsync_on_duplicate_api_resources_should_fail()
        {
            ...
            Func<Task> act = async () => await store.GetAllEnabledResourcesAsync();
            act.Should().ThrowAsync<Exception>(); // TODO: .And.Message.ToLowerInvariant().Should().Contain("duplicate").And.Contain("api resources");
        }
        ...
        public void GetAllEnabledResourcesAsync_on_duplicate_identity_scopes_should_fail()
        {
            ...
            a.Should().ThrowAsync<Exception>(); // TODO: .And.Message.ToLowerInvariant().Should().Contain("duplicate").And.Contain("identity scopes");
        }
